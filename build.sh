...
IMAGE_INSTALL:append = " network-config-static target-root-authorized-keys packagegroup-core-full-cmdline grow-rootfs aws-iot-mqtt mosquitto-clients gewgaw-collector"
